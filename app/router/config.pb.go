...
type StrategyChampionConfig struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// 连续不同观测快照上，挑战者完成晋级所需的胜场数。
	CandidateObservationCount int32 `protobuf:"varint,1,opt,name=candidate_observation_count,json=candidateObservationCount,proto3" json:"candidate_observation_count,omitempty"`
	// 连续不同观测快照上，preferred 完成回切所需的胜场数。
	PreferredObservationCount int32 `protobuf:"varint,2,opt,name=preferred_observation_count,json=preferredObservationCount,proto3" json:"preferred_observation_count,omitempty"`
	// 对 burst health ping 抖动的惩罚倍数；最终 score = average + deviation * scale。
	HealthPingJitterScale float32 `protobuf:"fixed32,3,opt,name=health_ping_jitter_scale,json=healthPingJitterScale,proto3" json:"health_ping_jitter_scale,omitempty"`
...
func (x *StrategyChampionConfig) Reset() {
	*x = StrategyChampionConfig{}
	mi := &file_app_router_config_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *StrategyChampionConfig) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*StrategyChampionConfig) ProtoMessage() {}

func (x *StrategyChampionConfig) ProtoReflect() protoreflect.Message {
	mi := &file_app_router_config_proto_msgTypes[5]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use StrategyChampionConfig.ProtoReflect.Descriptor instead.
func (*StrategyChampionConfig) Descriptor() ([]byte, []int) {
	return file_app_router_config_proto_rawDescGZIP(), []int{5}
}

func (x *StrategyChampionConfig) GetCandidateObservationCount() int32 {
	if x != nil {
		return x.CandidateObservationCount
	}
	return 0
}

func (x *StrategyChampionConfig) GetPreferredObservationCount() int32 {
	if x != nil {
		return x.PreferredObservationCount
	}
	return 0
}

func (x *StrategyChampionConfig) GetHealthPingJitterScale() float32 {
	if x != nil {
		return x.HealthPingJitterScale
	}
	return 0
}

func (x *StrategyChampionConfig) GetPreferredMaxDelayGap() int64 {
	if x != nil {
		return x.PreferredMaxDelayGap
	}
	return 0
}
...
const file_app_router_config_proto_rawDesc = "" +
	...
	"\ttolerance\x18\x06 \x01(\x02R\ttolerance\"\x88\x02\n" +
	...
	"\x17preferred_max_delay_gap\x18\x04 \x01(\x03R\x14preferredMaxDelayGap\"\x96\x02\n" +
	"\x06Config\x12O\n" +
...
var file_app_router_config_proto_goTypes = []any{
	...
	(*StrategyChampionConfig)(nil),  // 6: xray.app.router.StrategyChampionConfig
